...
if [ ! -f /home/arbuilder/.local/share/Tachidesk/docker_touchfile ]; then
	...
	curl -s --create-dirs -L https://raw.githubusercontent.com/suwayomi/tachidesk-preview/main/docker/server.conf -o /home/arbuilder/.local/share/Tachidesk/server.conf;
fi
echo ""
echo ""
echo "                                                                ************README***********"
